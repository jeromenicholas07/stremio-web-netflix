...
class StremioLauncherFULL
{
    ...
    const string LAUNCHER_VERSION = "2026-05-08-icon-tight";
    ...
    // full re-install.
    const string BASE_LAUNCHER_VERSION = "2026-05-08-icon-tight";
    ...
    const string ADDON_VERSION = "2026-05-07-search-no-cat-restrict";
